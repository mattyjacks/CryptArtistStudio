  ...
  const menus: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "DictatePic", shortcut: "P", action: () => navigate("/dictate-pic") },
        { separator: true, label: "" },
        { label: "\uD83D\uDC15 Virtual Pet [VPt]", shortcut: "V", action: () => navigate("/virtual-pet") },
        { label: "\uD83D\uDE4A Alive Speech [ASp]", shortcut: "A", action: () => navigate("/alive-speech") },
        { label: "\uD83D\uDCB0 Tax Info Bot [TIB]", shortcut: "T", action: () => navigate("/tax-info-bot") },
        { separator: true, label: "" },
