  ...
  const menus: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { separator: true, label: "" },
        { label: "Media Mogul", shortcut: "1", action: () => navigate("/media-mogul") },
        { label: "VibeCodeWorker", shortcut: "2", action: () => navigate("/vibecode-worker") },
        { label: "DemoRecorder", shortcut: "3", action: () => navigate("/demo-recorder") },
        { label: "ValleyNet", shortcut: "4", action: () => navigate("/valley-net") },
        { label: "GameStudio", shortcut: "5", action: () => navigate("/game-studio") },
        { label: "CryptArt Commander", shortcut: "6", action: () => navigate("/commander") },
        { label: "DonatePersonalSeconds", shortcut: "7", action: () => navigate("/donate-personal-seconds") },
        { label: "Clone Tool", shortcut: "9", action: () => navigate("/clone-tool") },
        { label: "Settings", shortcut: "0", action: () => navigate("/settings") },
      ],
    },
    {
      label: "Run",
