...
const programs = [
  ...
  },
  {
    ...
    name: "Master",
    code: "Mst",
    emoji: "\u{1F468}\u{1F3FC}\u200D\u{1F9B3}",
    description: "Advanced system monitor & task manager - Better than Windows Task Manager",
    gradient: "from-slate-600/20 to-zinc-600/20",
    borderHover: "hover:border-slate-500/40",
    accentColor: "text-slate-400",
    version: "v1.0.0",
    shortcut: "M",
    tags: ["utilities", "system", "monitor", "task", "performance", "processes"],
  },
  {
    id: "commander",
  ...
  },
  {
    ...
    code: "TIB",
    emoji: "�",
    description: "Upload 50+ financial documents. AI automatically extracts data, links W-8BENs to Crypto/PayPal, and audits them on-chain for 90% automation.",
    gradient: "from-blue-600/20 to-indigo-600/20",
    borderHover: "hover:border-blue-500/40",
    accentColor: "text-blue-400",
    version: "v1.0.0",
    shortcut: "T",
    tags: ["tax", "finance", "ai", "crypto", "blockchain"],
  },
  {
    id: "settings",
    name: "Settings",
